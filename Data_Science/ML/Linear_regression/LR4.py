import pandas as pd
import joblib #save trained ML model
import imaplib # fetch mail
import email #helps extract:-sender,subject,body,attachments
import smtplib #send emails
import re # Regular Expressions extract clean email address from sender field
